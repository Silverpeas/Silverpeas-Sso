...
package org.silverpeas.sso.kerberos.settings;
...
public class KerberosSettings {
  private static final String SETTINGS_PATH = "org.silverpeas.sso.kerberos";
  ...
  public static String getSilverpeasDomainId() {
    return getSettings().getString("kerberos.silverpeas.domain.id");
  }
}
